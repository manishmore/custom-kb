...
<div class="block bgWhite">
	<div class="content">
		<form action="vendor/edit/<?php echo $item['id']; ?>" method="post">
			<table width="100%">
				<tr>
				...
				<tr>
					<td colspan="2" style="text-align: right;">
						<input type="button" value="Cancel" style="width:60px;" onclick="window.location.href='vendor/detail/<?php echo $item['id']; ?>'"/>
